...
<html>
	...
	<body>
		<a href="#edit-observacion" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-observacion" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${observacionInstance?.version}" />
				<fieldset class="form">
